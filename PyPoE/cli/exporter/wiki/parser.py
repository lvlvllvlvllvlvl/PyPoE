...
_inter_wiki_map = {
    "English": (
        ...
        ("Mana", {"link": "Mana"}),
        ("Reserv(?:e|ed|ation)", {"link": "Reservation"}),
        ("Regenerat(?:e|ed|ion)", {"link": "Regeneration"}),
        ...
        ("Raise(?:|ed) Spider(?:|s)", {"link": "Raise Spiders"}),
        ...
        ("(?:|Summon(?:|ed) )Spectral Wol(?:f|ves)", {"link": "Summon Spectral Wolf"}),
        ...
        #
        # Generic
        ("One Handed Melee Weapon(?:|s)", {"link": "One Handed Melee Weapons"}),
